...
public class BoardResponseDto {
    ...
    public BoardResponseDto(Long id, Long userId, String title, String contents, List<String> images,
    ...
    public static BoardResponseDto of(Board board, List<CommentInfoResponseDto> comments) {
        return new BoardResponseDto(board.getId(), board.getUser().getId(), board.getTitle(),
                board.getContents(),
                board.getImages().stream().map(FileUtils::joinFileName).toList(), comments,
