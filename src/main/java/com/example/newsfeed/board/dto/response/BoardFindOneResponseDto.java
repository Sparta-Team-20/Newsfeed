...
public class BoardFindOneResponseDto {
    ...
    public BoardFindOneResponseDto(Long id, Long userId, String title, String contents, List<ImageResponseDto> images,
    ...
    public static BoardFindOneResponseDto of(Board board, List<CommentInfoResponseDto> comments) {
        return new BoardFindOneResponseDto(board.getId(), board.getUser().getId(), board.getTitle(),
                board.getContents(),
